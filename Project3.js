...
let scoreCounter = document.querySelector('.scoreText').textContent;
let highScore = document.querySelector('.highScore');
const hintText = document.querySelector('.hintWord');
let questionText = document.querySelector('.question-text');
let guessingHistory = document.querySelector('.history');
let checkBox = document.querySelector('.guess2');
let inputBox = document.querySelector('.guess1');


document.querySelector('.guess2').addEventListener('click', function (){
    const inputNumber = Number(document.querySelector('.guess1').value) ;
